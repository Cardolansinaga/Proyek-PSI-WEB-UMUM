    ...
    <section class="school-hero hero-achievement">
        ...
        <div class="mx-auto grid min-h-[520px] max-w-7xl items-center px-4 py-20 lg:px-8">
            <div class="relative max-w-3xl">
                <span class="section-pill">Budaya Prestasi</span>
    ...
    <section class="bg-[#f6f9fc] py-20 sm:py-24">
        <div class="mx-auto max-w-7xl px-4 lg:px-8">
            <div class="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
                <div><p class="eyebrow">Kebanggaan Terkini</p><h2 class="mt-3 text-4xl font-black text-[#071f3a] sm:text-5xl">Prestasi Unggulan 2026</h2></div>
    ...
    <section id="galeri-prestasi" class="bg-white py-20 sm:py-24">
        <div class="mx-auto max-w-7xl px-4 lg:px-8">
            <div class="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
                ...
                <div class="flex flex-wrap gap-3">@foreach (['Semua', 'Akademik', 'Olahraga', 'Seni'] as $filter)<a href="#galeri-prestasi" class="filter-pill {{ $loop->first ? 'active' : '' }}">{{ $filter }}</a>@endforeach</div>
            </div>
    ...
    <section class="bg-white px-4 pb-24 lg:px-8">
        <div class="cta-panel">
            ...
            <div class="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
                ...
                <a href="{{ route('kesiswaan') }}" class="ghost-button">Kegiatan Kesiswaan</a>
            </div>
        </div>
    </section>
@endsection
