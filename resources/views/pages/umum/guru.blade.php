...
@section('content')
    <section class="teacher-hero page-hero text-center">
        ...
        <div class="mx-auto max-w-7xl px-4 py-24 sm:py-32 lg:px-8">
            <div class="relative mx-auto max-w-5xl animate-fade-in-up">
                <span class="section-pill animate-fade-in" style="animation-delay: 0.1s;">Sumber Daya Manusia</span>
                <h1 class="mt-7 text-5xl font-black leading-[1] text-white sm:text-6xl lg:text-7xl animate-fade-in-up" style="animation-delay: 0.2s;">Guru & Tenaga Kependidikan</h1>
                <p class="mx-auto mt-7 max-w-3xl text-base font-semibold leading-8 text-white/74 animate-fade-in-up" style="animation-delay: 0.3s;">
    ...
    <section class="bg-[#f6f9fc] py-20 sm:py-24">
        <div class="mx-auto max-w-7xl px-4 text-center lg:px-8">
            ...
            <div class="mt-14 grid gap-8 md:grid-cols-3">
                <article class="leader-card hover-lift animate-fade-in-up stagger-1"><div class="avatar male"></div><h3>Drs. J. Marpaung, M.Pd</h3><p>Kepala Sekolah</p></article>
                <article class="leader-card hover-lift animate-fade-in-up stagger-2"><div class="avatar female"></div><h3>S. Simanjuntak, S.Pd</h3><p>Waka. Kurikulum</p></article>
                <article class="leader-card hover-lift animate-fade-in-up stagger-3"><div class="avatar male alt"></div><h3>R. Hutapea, M.Si</h3><p>Waka. Kesiswaan</p></article>
            </div>
        </div>
    </section>
    ...
    <section id="direktori" class="bg-white py-20">
        <div class="mx-auto max-w-7xl px-4 lg:px-8">
            ...
            <div class="mt-12 grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
                <article class="teacher-card teacher-a hover-lift animate-fade-in-up stagger-1"><div></div><h3>Ani Siahaan, S.Pd</h3><p>Matematika & Kalkulus</p><a href="{{ route('home') }}#kontak">Hubungi Sekolah -></a></article>
                <article class="teacher-card teacher-b hover-lift animate-fade-in-up stagger-2"><div></div><h3>Dr. David Pardede</h3><p>Fisika Terapan</p><a href="{{ route('home') }}#kontak">Hubungi Sekolah -></a></article>
                <article class="teacher-card teacher-c hover-lift animate-fade-in-up stagger-3"><div></div><h3>M. Napitupulu, M.Hum</h3><p>Bahasa & Sastra</p><a href="{{ route('home') }}#kontak">Hubungi Sekolah -></a></article>
                <article class="teacher-card teacher-d hover-lift animate-fade-in-up stagger-4"><div></div><h3>T. Siregar, S.Kom</h3><p>Informatika & TIK</p><a href="{{ route('home') }}#kontak">Hubungi Sekolah -></a></article>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#071f3a] py-20 text-center text-white">
        <div class="mx-auto max-w-7xl px-4 lg:px-8">
            ...
            <p class="mx-auto mt-5 max-w-2xl text-sm font-semibold leading-7 text-white/78">Pilar operasional yang memastikan seluruh aktivitas sekolah berjalan dengan prima setiap harinya.</p>
            <div class="mt-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
                <article class="staff-card hover-lift animate-fade-in-up stagger-1"><div class="avatar female"></div><h3>H. Tobing</h3><p>Kepala Tata Usaha</p></article>
                <article class="staff-card hover-lift animate-fade-in-up stagger-2"><div class="avatar male"></div><h3>B. Situmorang</h3><p>Pustakawan Utama</p></article>
                <article class="staff-card hover-lift animate-fade-in-up stagger-3"><div class="avatar female alt"></div><h3>D. Tambunan</h3><p>Bendahara Sekolah</p></article>
                <article class="staff-card hover-lift animate-fade-in-up stagger-4"><div class="avatar male alt"></div><h3>R. Pangaribuan</h3><p>Koordinator Laboran</p></article>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#f6f9fc] px-4 py-20 text-center lg:px-8">
        ...
        <div class="mt-9 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <a class="rounded-full bg-white px-8 py-4 text-sm font-black text-[#071f3a] ring-1 ring-[#dfe8ef]" href="{{ route('home') }}#kontak">Hubungi Kami</a>
        </div>
    </section>
@endsection
